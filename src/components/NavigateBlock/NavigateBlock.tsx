  ...
  return (
    <div className="navigate-block">
      <div className="navigate-block__paging-area">
        <span
          className={`navigate-block__page${isLastPage ? " navigate-block__page_gray" : ""}`}
        >
          {page}
        </span>
        <div
          className={`navigate-block__decor${isLastPage ? " navigate-block__decor_gray" : ""}`}
        ></div>
        <span className="navigate-block__page navigate-block__page_gray">
          {maxPage}
        </span>
      </div>
